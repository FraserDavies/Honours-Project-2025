...
\begin{itemize}
    ...
    \item	\textbf{	NFR2	}	-	\textbf{	M	}	-	\textbf{	Web Browser Compatibility	}		
    ...
    \item	\textbf{	NFR3	}	-	\textbf{	M	}	-	\textbf{	Data Security and GDPR Compliance	}		
    As a student, the system must store all my project data securely and be GDPR-compliant.
    
    \item	\textbf{	NFR4	}	-	\textbf{	S	}	-	\textbf{	Response Time Performance	}		
    ...
    \item	\textbf{	NFR5	}	-	\textbf{	S	}	-	\textbf{	Intuitive User Interface	}		
    ...
    \item	\textbf{	NFR6	}	-	\textbf{	S	}	-	\textbf{	Mobile-Friendly Responsive Design	}		 
    ...
    \item	\textbf{	NFR7	}	-	\textbf{	C	}	-	\textbf{	Accessibility Compliance	}		
    ...
    \item	\textbf{	NFR8	}	-	\textbf{	C	}	-	\textbf{	Scalability for Multiple Concurrent Users	}		
