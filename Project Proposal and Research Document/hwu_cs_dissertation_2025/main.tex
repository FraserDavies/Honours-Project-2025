...
\begin{itemize}
    ...
    \item \textbf{Interactive visualization}: Confirming that the D3.js-based Gantt chart accurately represents task data and responds correctly to user interactions such as drag-and-drop timeline adjustments (FR4, FR8).
