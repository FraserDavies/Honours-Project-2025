...
\begin{figure}[ht]
    ...
    \fbox{\includegraphics[width=0.95\textwidth]{images/ER-diagram.png}}
...
as \texttt{TEXT} in \texttt{YYYY-MM-DD} ISO 8601 format [TODO: REFERENCE TS]. This means date parsing is handled
