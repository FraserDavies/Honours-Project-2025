...
\begin{itemize}
    \item Chapter \ref{cha:intro}: Introduces the project, outlining the background and motivation, aim and objectives, and the organisation of the report.
    \item Chapter \ref{cha:back}: Presents the background research, discussing related work found in the technical literature and its relevance to the project.
\end{itemize}
...
% What to cover:
% - History and evolution of Gantt charts (Henry Gantt)
% - Core components of Gantt charts (tasks, milestones, dependencies, timelines)
% - Types of dependencies (finish-to-start, start-to-start, finish-to-finish, start-to-finish)
% - Gantt charts vs. other project management tools (Kanban boards, network diagrams/PERT charts)
% - Role of Gantt charts in project management \cite{wadhwa_role_2024}
% - Review of existing work in the area of your project
